...
namespace GameUnitTest
{
    ...
    public class GameServiceTest
    {
        ...
        public void GetGame_NULLTest()
        {
            //Game game = gameService.GetGameByKey(null);
        }
        ...
        [TestMethod]
        public void ValidateKey_Test()
        {
            bool result = gameService.ValidateKey("001");

            Assert.IsFalse(result);
        }

        [TestMethod]
        public void ValidateKey_WrongKeyTest()
        {
            bool result = gameService.ValidateKey("AAA1");
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void ValidateKey_NullKeyTest()
        {
            bool result = gameService.ValidateKey(null);
        }

        [TestMethod]
        public void GetGamesCount_Test()
        {
            int result = gameService.GetGamesCount();
            int expected = gameRepo.Object.Get().Count();
        ...
        public void GetGameNullException()
        {
           // gameService.GetGameByKey(null);
        }

        [TestMethod]
        [ExpectedException(typeof(System.ArgumentException))]
        public void GetGameArgumentException()
        {
          /*  gameService.GetGameByKey("11111111111111111111111111111111111111111111111111111111111111" +
